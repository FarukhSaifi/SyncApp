...
export const useToast = () => {
  ...
  const apiSuccess = useCallback(
    (message: string, title: string = TOAST_TITLES.SUCCESS) => {
  ...
  const apiError = useCallback(
    (message: string, title: string = TOAST_TITLES.ERROR) => {
  ...
  const apiLoading = useCallback(
    (message: string, title: string = TOAST_TITLES.LOADING) => {
  ...
  const authError = useCallback(
    (message: string = TOAST_TITLES.AUTH_ERROR) => {
  ...
  const withToast = useCallback(
    (promise: Promise<unknown>, options: WithToastOptions = {}) => {
      const {
