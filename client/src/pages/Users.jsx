...
const Users = () => {
  ...
  const [verifiedFilter, setVerifiedFilter] = useState(VERIFIED_FILTER_ALL);
              ...
              <div className="flex flex-wrap items-center gap-2 text-sm">
                ...
                {roleFilter && (
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-muted text-muted-foreground text-xs">
                    Role: {USER_ROLE_OPTIONS.find((o) => o.value === roleFilter)?.label ?? roleFilter}
                  </span>
                )}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setAddForm((f) => ({ ...f, avatar: e.target.value }))}
